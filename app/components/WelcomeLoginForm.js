...
class WelcomeLoginForm extends Component {
  ...
  render() {
    return (
      <Container>
        <LinearGradient colors={['#7EB9F8', '#7EB9F8', '#7EB9F8']} style={{flex: 1, flexDirection: 'column', justifyContent: 'space-around'}}>
          <View style={styles.logoContainer}>
            <Image source={require('../assets/img/logo.png')}  style={{alignSelf: 'center'}} resizeMode={"cover"}/>
          </View>
            <Form style={styles.form}>
              ...
              <View>
                <Button block light onPress={this.handleSubmit} style={styles.button} >
                  <Text style={{color: "white", fontWeight: '400', fontSize: 20}}>Log In</Text>
                </Button>
                 <View style={{alignItems: 'flex-end', alignSelf: 'center', margin: 10, flexDirection: 'row', top: 30}}>
                  <Text style={{color: "black", backgroundColor: 'transparent'}}>Not signed up yet?&nbsp;</Text>
